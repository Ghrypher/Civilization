...
class GameMain():
    ...
    def __init__(self):
        ...
        '''Instructions'''
        self.menubuttoninstructions = pygame.image.load('C:/Users/santi/OneDrive/Escritorio/Santiago/Prog. Or. Obj/T-H-E/Civilization/V Abelle/resources/images/menubuttontexture.jpg')
