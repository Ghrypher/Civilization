...
class GameMain():
    ...
    """Function resourcesLoad, loads all the resources from the game using the gameresources helper"""
    def resourcesLoad(self):
        """Menues All"""
    ...
    def gameMapSelector(self,playing):
        ...
        """Game"""
        self.swordcursor,self.foundersprite,self.founderspriteposx,self.founderspriteposy,self.founderspritecoll,self.biometiles,self.gamemusic1,self.gamemusic2,self.hidden = gameres.gameLoads() #Uses the gameLoads function from gameresources
        self.playing = playing
        while self.playing == True:
