...
class GameView():
    ...
    def gameLoads(self,num):
        ...
        if num == 1:
            ...
            biometiles = {"B" : pygame.image.load("resources/assets/map/floor/Barrier.png"),
                            ...
                            "H" : "Hidden",
                            "0" : False,
                            "1" : True} #Dictionary that records the different sprites from the leeters that appears on the map txt
